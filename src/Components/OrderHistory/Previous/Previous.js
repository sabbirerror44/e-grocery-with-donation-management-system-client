...
const Previous = () => {
    ...
    useEffect(()=>{
        fetch(`https://powerful-sierra-34042.herokuapp.com/order/delivered/${localStorage.getItem('userMobile')}`)
            .then(res => res.json())
            .then((data) =>{
                setOrders(data);
            });
    ...
    return (
        <div className="backgroundColorSingle">
           ...
           <div className="page">
            <h3 className="text-center titleStyle mb-4">Your Previous Orders</h3>
                <Row>
